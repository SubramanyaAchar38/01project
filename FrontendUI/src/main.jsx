...
// --- FIXED IMPORT PATHS ---
// The paths have been corrected to point directly to the 'pages' folder.
import Home from './pages/Home.jsx';
import FindServices from './pages/FindServices.jsx';
import ContactUs from './pages/ContactUs.jsx';
import HowItWorks from './pages/HowItWorks.jsx';
import SignIn from './pages/SignIn.jsx';
import ProviderProfile from './pages/ProviderProfile.jsx';
import ProviderSignUp from './pages/ProviderSignUp.jsx'; // Duplicate import removed
import CustomerSignUp from './pages/CustomerSignUp.jsx';
import MyBookings from './pages/MyBookings.jsx';
...
const router = createBrowserRouter(
  createRoutesFromElements(
    <>
      ...
      {/* Optional: A catch-all route for any page not found */}
